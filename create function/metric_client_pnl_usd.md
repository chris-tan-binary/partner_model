bo
```
CREATE OR REPLACE FUNCTION development.update_partner_fact_client_pnl_usd_bo(
	p_start_date date,
	p_end_date date)
    RETURNS void
    LANGUAGE 'sql'
...
mt5
```
CREATE OR REPLACE FUNCTION development.update_partner_fact_client_pnl_usd_mt5(
	p_start_date date,
	p_end_date date)
    RETURNS void
    LANGUAGE 'sql'
