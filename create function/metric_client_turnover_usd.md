```
CREATE OR REPLACE FUNCTION development.update_partner_fact_client_turnover_usd(
	p_start_date date,
	p_end_date date)
    RETURNS void
    LANGUAGE 'sql'
...
where transaction_date >= p_start_date::date and transaction_date < p_end_date::date
